...
export default class Base64Out {
    private static _Instance: Base64Out = null;
    private constructor() {}
    public static getInstance() {
        if (!Base64Out._Instance) {
            Base64Out._Instance = new Base64Out();
        }
        return Base64Out._Instance;
    }
